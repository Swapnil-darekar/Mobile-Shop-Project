...
insert into mylogin values ('mj','mj123','I Love','sonu');
...
class Login11 extends JFrame implements ActionListener
{
Connection conn;
	Statement s;
	ResultSet rs;
  ...
  try
			{	
			conn = DriverManager.getConnection("jdbc:mysql://localhost:3307/project1","root","");
